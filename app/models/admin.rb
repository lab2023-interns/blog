class Admin < ActiveRecord::Base
  ...
  # Callbacks
  after_commit :send_login_info, :send_welcome_message, :send_welcome_second_message, on: :create
  ...
  def send_welcome_second_message
    AdminMailer.second_welcome(self.id).deliver_later!
  end
